def megisto(sinartisi):
    ...
    for i in lisi:
        if f(i) > 0:
            print('\n > Min: y* =', sinar(i),'\n        x* =',i)
            ax.annotate("Min",xytext=(2,1),xy=(i,sinar(i)), arrowprops={'facecolor':'black'})

        else:
            print('\n > Max: y* =',sinar(i),'\n        x* =',i)
            ax.annotate("Max",xytext=(1,-2.5),xy=(i,sinar(i)), arrowprops={'facecolor':'black'})
    plt.show()
...
print('                 |                                                  |')
print('                 |       E X T E R M A L  W I T H  P Y T H O N      |')
print('                 |__________________________________________________|')
